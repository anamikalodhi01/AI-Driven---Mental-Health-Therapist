...
//         {/* Vertical Slider Track with Thumb */}
...
//       <TouchableOpacity style={styles.continueButton} onPress={() => router.push('/next-screen')}>
